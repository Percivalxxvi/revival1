...
const About = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-[#150f33] text-white py-20">
      ...
      {/* <section className="container mx-auto px-6 py-16">
        ...
        <p className="text-gray-700 mb-8">
          To inspire and guide individuals in their spiritual journey through
          teachings, fellowship, and outreach programs.
        </p>
        ...
        <p className="text-gray-700 mb-8">
          To create a world where every individual experiences the
        ...
        <p className="text-gray-700 mb-8">
          From local outreach programs in Nigeria to online global broadcasts,
          we engage in worship, education, and community service.
        </p>
      </section> */}
